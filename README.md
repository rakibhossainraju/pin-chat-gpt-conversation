...
> [!IMPORTANT]
> Do not delete the extension directory after installation. Chrome references these files directly, and removing them will cause the extension to stop working.
